...
?>
<div class="d-flex justify-content-between flex-wrap align-items-center gap-2 pb-2 mb-3 border-bottom"><div><h1 class="h2 mb-1">Flight Details</h1><p class="text-muted mb-0">Separate arrival and departure groups submitted by each delegation.</p></div><div class="d-flex gap-2"><a class="btn btn-outline-primary" href="flight_details_export.php?direction=arrival"><i class="bi bi-file-earmark-pdf me-1"></i>Arrival PDF</a><a class="btn btn-outline-success" href="flight_details_export.php?direction=departure"><i class="bi bi-file-earmark-pdf me-1"></i>Departure PDF</a></div></div>
