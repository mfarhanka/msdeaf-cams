...
?>
<div class="d-flex justify-content-between align-items-center border-bottom mb-3 pb-2"><div><h1 class="h2 mb-1">Volunteer Applications</h1><p class="text-muted mb-0">Review general volunteer-pool applications and issue approved accounts.</p></div><div class="d-flex align-items-center gap-2"><span class="badge bg-primary fs-6"><?php echo count($applications); ?> shown</span><a class="btn btn-primary" href="volunteer_add.php">Add Volunteer</a></div></div>
<?php if (($_GET['added'] ?? '') === '1'): ?><div class="alert alert-success">Volunteer added successfully as a pending application.</div><?php endif; ?>
