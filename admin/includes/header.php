...
<div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="mobileNavigation" aria-labelledby="mobileNavigationLabel">
    ...
    <div class="offcanvas-body d-flex flex-column p-3">
        ...
        <div class="nav flex-column nav-pills">
            ...
            <a class="nav-link w-100 text-start <?php echo $current_page == 'hotel_accounts.php' ? 'active' : ''; ?>" href="hotel_accounts.php"><i class="bi bi-key me-2"></i>Hotel Accounts<span class="badge rounded-pill text-bg-danger ms-2">NEW</span></a>
            ...
            <a class="nav-link w-100 text-start <?php echo $current_page == 'meals.php' ? 'active' : ''; ?>" href="meals.php"><i class="bi bi-egg-fried me-2"></i>Meal Preferences<span class="badge rounded-pill text-bg-danger ms-2">NEW</span></a>
            <a class="nav-link w-100 text-start <?php echo $current_page == 'flights.php' ? 'active' : ''; ?>" href="flights.php"><i class="bi bi-airplane-fill me-2"></i>Flight Details</a>
            <a class="nav-link w-100 text-start ps-4 <?php echo $current_page == 'arrivals.php' ? 'active' : ''; ?>" href="arrivals.php"><i class="bi bi-airplane-engines me-2"></i>Arrivals<span class="badge rounded-pill text-bg-danger ms-2">NEW</span></a>
            <a class="nav-link w-100 text-start ps-4 <?php echo $current_page == 'departures.php' ? 'active' : ''; ?>" href="departures.php"><i class="bi bi-airplane me-2"></i>Departures<span class="badge rounded-pill text-bg-danger ms-2">NEW</span></a>
