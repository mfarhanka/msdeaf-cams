...
function generateInvoicePdf(array $s, string $number, string $issuedAt, ?array $payment=null): string
{
    ...
    $line('BANK DETAILS',35,9,true); $lineRight('TOTAL AMOUNT:',$summaryLabelRight,10,true); $lineRight('USD $ '.number_format($s['total'],2),$summaryValueRight,11,true); $y-=14;
