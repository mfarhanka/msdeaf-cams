...
function invoiceSettingDefaults(): array
{
    return [
        ...
        'invoice_currency' => 'USD', 'invoice_participation_fee' => '50.00',
...
function generateInvoicePdf(array $s, string $number, string $issuedAt): string
{
    ...
    $newPage=function() use (&$pages,&$content,&$y,$s,$number,$issuedAt,&$line,&$lineRight,&$rule) {
